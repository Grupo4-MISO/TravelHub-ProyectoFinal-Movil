...
public interface IBookingService
{
    ...
    Task<HttpResponseWrapper<object>> CheckInBookingByReservationIdAsync(string bookingId);
    Task<HttpResponseWrapper<object>> RevokeBookingByReservationIdAsync(string bookingId);
